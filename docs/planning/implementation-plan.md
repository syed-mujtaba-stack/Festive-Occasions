...
- **Phase 1 — Audit** — docs/audit/* (repository, live-site, assets, technical-seo)
- **Phase 2 — Research** — competitors, keywords, UX patterns (docs/seo/*)
- **Phase 3 — Planning** — sitemap, wireframes, design system, component system, animation system (docs/planning/*)
...
- **Phase 11 — Performance** — images, fonts, JS, GSAP, video
- **Phase 12 — QA** — responsive, animation, SEO, performance, final walkthrough
