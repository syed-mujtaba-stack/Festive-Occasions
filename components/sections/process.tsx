          ...
          <ol className="relative">
            ...
            {steps.map((s, i) => (
              <ScrollReveal key={s.n} as="li" y={30} delay={i * 0.05}>
                <div className="group relative flex gap-7 pb-14">
                  <span className="relative z-10 flex h-8 w-4 shrink-0 items-center justify-center">
                    <span className="h-2.5 w-2.5 rounded-full border-2 border-champagne bg-cream transition-colors duration-300 group-hover:bg-champagne" />
                  </span>
                  <div>
